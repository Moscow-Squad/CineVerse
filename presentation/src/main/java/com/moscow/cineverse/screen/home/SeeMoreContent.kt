...
fun <T : Any> SeeMoreContent(
    uiState: SeeMoreHomeState,
    gridState: LazyGridState,
    contentList: LazyPagingItems<T>,
    interactionListener: SeeMoreHomeInteractionListener,
...
@Composable
fun SeeMoreContentPreview() {
    val mockUiState = SeeMoreHomeState(
        title = "See More",
        isLoading = false,
    ...
    val mockGridState = rememberLazyGridState()
    ...
    val mockData = (mockMovies)

    val mockContentList = flowOf(PagingData.from(mockData)).collectAsLazyPagingItems()

    val mockInteractionListener = object : SeeMoreHomeInteractionListener {
    ...
    SeeMoreContent(
        ...
        interactionListener = mockInteractionListener
    )
}
